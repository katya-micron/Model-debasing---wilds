...
additional_transforms = ['randaugment', 'weak','weak_v2']
...
models = ['resnet18_ms', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'wideresnet50',
         ...
         'fasterrcnn', 'unet-seq', 'resnet50_gn','resnet50_gn_ws','BiT-M-R50x1','BiT-M-R50x3'
         ,'resnet50_gnws_silu','resnet50_gn_silu','resnet50_gnws_LeakyRelu','resnet50_gnws_gelu',
         'resnet18_gnws_silu',
         ]
...
'cross_entropy_logits','logitNorm_loss','FocalLoss','mse_logitNormLoss',]
