dataset_defaults = {
    ...
    'camelyon17_nopr': {
        'split_scheme': 'official',
        'model': 'resnet50_gnws_silu', #densenet121',
        'model_kwargs': {'pretrained': False},
        'transform': 'image_base',
        'target_resolution': (96, 96),
        #'loss_function': 'cross_entropy',
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 1,},
        ...
        'scheduler_kwargs': {'milestones':[5,8], 'gamma': 0.1},
        'batch_size': 192,
    ...
    'camelyon17': {
        ...
        'model_kwargs': {'pretrained': True,
            'frozen_layers': 6},
        'pretrained_model_path': '/home/katyag/OHSU/Detection/wilds/resnet50_GNws_8xb32_silu_in1k.pth',
        'transform': 'image_base',
        'target_resolution': (96, 96),
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 1,},
    ...
    'fmow': {
        ...
        'pretrained_model_path': '/home/katyag/OHSU/Detection/wilds/BiT-M-R50x1.npz',
        'transform': 'image_base',
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 0.5,},
        'groupby_fields': ['year',],
        ...
        'optimizer': 'AdamW',
        'scheduler': 'MultiStepLR',
        'scheduler_kwargs': {'milestones':[8,16], 'gamma': 0.1},
        'batch_size': 192,
        'unlabeled_batch_size': 32,
        'lr': 0.0001,
        'weight_decay': 0.001,
    ...
    'fmow_1': {
        ...
        'model': 'resnet50_gnws_silu',
        'model_kwargs': {'pretrained': True,
            'frozen_layers':0,#6,
               },
        'pretrained_model_path': '/home/katyag/OHSU/Detection/wilds/resnet50_GNws_8xb32_silu_in1k.pth',
        #'pretrained_model_path': '/home/katyag/OHSU/Detection/wilds/resnet50_GNws_silu.pth',
        'transform': 'image_base',
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 0.5,},
        'groupby_fields': ['year',],
    ...
    'iwildcam_v2': {
        ...
        'pretrained_model_path': '/home/katyag/OHSU/Detection/wilds/BiT-M-R50x3.npz',
        'transform': 'image_base',
        'additional_train_transform': 'weak_v2',
        ...
        'split_scheme': 'official',
        'scheduler': 'MultiStepLR',
        'scheduler_kwargs': {'milestones':[7,10], 'gamma': 0.1},
    ...
    'poverty_1': {
        ...
        'batch_size': 64, #528, #432, #384, #64,
        'unlabeled_batch_size': 64,
        'lr': 0.001,
        'weight_decay': 0.001, #0001, #0.0,
        'n_epochs': 50, #200,
        'n_groups_per_batch': 8,
        'unlabeled_n_groups_per_batch': 4,
        'irm_lambda': 1.0,
    ...
    'poverty': {
        ...
        'model': 'resnet18_gnws_silu', #'BiT-M-R18x1'
        #'model': 'resnet18_ms',
        'model_kwargs': {'num_channels': 8,
             'pretrained':False
             },
    ...
    'rxrx1': {
        'split_scheme': 'official',
        'model': 'resnet50_gnws_silu', #'resnet50_gn_ws',
        'model_kwargs': {'pretrained': True},
        'transform': 'rxrx1',
        'transform': 'image_base',
        'additional_train_transform': 'weak',
        'target_resolution': (348, 348),
        'loss_function': 'cross_entropy',
    ...
    'globalwheat': {
        ...
        'model_kwargs': {
            'n_classes': 1,
            'pretrained': True,
            'backbone_model': 'resnet50_gnws_silu',
            'pretrained_backbone_path':'/home/katyag/OHSU/Detection/wilds/resnet50_GNws_silu.pth',
        },
    ...
    'globalwheat_v1': {
        ...
        'model_kwargs': {
            'n_classes': 1,
            'pretrained': True,
            'backbone_model': 'BiT-M-R50x1',
            'pretrained_backbone_path':'/home/katyag/OHSU/Detection//wilds/BiT-M-R50x1.npz',
        },
        'loss_function': 'fasterrcnn_criterion',
        'groupby_fields': ['session'],
        'val_metric': 'detection_acc_avg_dom',
