dataset_defaults = {
    ...
    'camelyon17': {
        ...
        'model_kwargs': {'pretrained': True,
            'frozen_layers': 6},
        'pretrained_model_path': './resnet50_GNws_8xb32_silu_in1k.pth',
        'transform': 'image_base',
        'target_resolution': (96, 96),
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 1,},
    ...
    'fmow': {
        ...
        'pretrained_model_path': './BiT-M-R50x1.npz',
        'transform': 'image_base',
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 0.5,},
        'groupby_fields': ['year',],
    ...
    'fmow_1': {
        ...
        'pretrained_model_path': './resnet50_GNws_8xb32_silu_in1k.pth',
        #'pretrained_model_path': './resnet50_GNws_silu.pth',
        'transform': 'image_base',
        'loss_function': 'logitNorm_loss',
        'loss_kwargs': {'t': 0.5,},
        'groupby_fields': ['year',],
    ...
    'iwildcam_v2': {
        ...
        'pretrained_model_path': './BiT-M-R50x3.npz',
        'transform': 'image_base',
    ...
    'globalwheat': {
        ...
        'model_kwargs': {
            ...
            'pretrained_backbone_path':'./resnet50_GNws_silu.pth',
        },
    ...
    'globalwheat_v1': {
        ...
        'model_kwargs': {
            ...
            'pretrained_backbone_path':'./BiT-M-R50x1.npz',
        },
        'loss_function': 'fasterrcnn_criterion',
        'groupby_fields': ['session'],
        'val_metric': 'detection_acc_avg_dom',
