...
from examples.models.resnet_GNws_SiLu import ResNet50
model_urls = {
...
def fasterrcnn_resnet50_fpn(pretrained=False, progress=True,
                            num_classes=91, pretrained_backbone=True, trainable_backbone_layers=3,
                             backbone_name ='Resnet50',backbone_path =None,   **kwargs):
    ...
    if backbone_path is not None:
        ...
        state_dict = torch.load(backbone_path) #'/home/katyag/wilds/resnet50_GNws_8xb32_silu_in1k.pth')
        #for k,v in state_dict['state_dict'].items():
        #    print("state dict: ",k)
        if not "backbone.body." in state_dict['state_dict'].keys():
        ...
        if not 'bn1' in state_dict['state_dict'].keys():
