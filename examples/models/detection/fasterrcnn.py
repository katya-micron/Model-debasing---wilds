...
def fastrcnn_loss(class_logits, box_regression, labels, regression_targets):
    ...
    weight=torch.tensor([0.7,0.3]).to("cuda")
    #weight.device = class_logits.device
    classification_loss = []
    box_loss = []
...
class FastWILDS(GeneralizedRCNN):
    def __init__(self, backbone, num_classes=None,
        ...
        image_std = [1., 1., 1.]
        # use the following rangle of sizes if you want multiresize transformation
